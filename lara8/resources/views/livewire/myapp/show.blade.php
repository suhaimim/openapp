    ...
    <div>
        <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
            ...
            @endif
            <button wire:click="create()" class="border-2 border-indigo-400 bg-indigo-500 text-white font-bold py-2 px-4 rounded my-3">New App</button>
            @if($isDialogOpen)
            @include('livewire.myapp.create')
            @endif      

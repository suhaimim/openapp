    ...
    <div>
        <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
            ...
            @endif
            <button wire:click="create()" class="border-2 border-indigo-400 bg-indigo-500 text-white font-bold py-2 px-4 rounded my-3">Add Team</button>
            @if($isDialogOpen)
            ...
            <table class="table-fixed w-full leading-normal">
                <thead>
                    <tr class="px-5 py-3 border-b-2 border-gray-600 bg-gray-200 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                        ...
                        <th class="px-4 py-2" style="width: 120px">Owner</th>
